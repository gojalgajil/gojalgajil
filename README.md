...
### 🧾 [Split Bill Web-app](https://github.com/gojalgajil/Splity)
**Frontend:** Next.js 16.0.7, React 19.2.0, TypeScript 5.9.3  
**Styling & UI:** Tailwind CSS 3.4.18, shadcn/ui, Radix, Lucide React, Tailwind CSS Animate, next-themes  
...
### 🔬 [KOMPOSISIKU (My-Ingredients)](https://github.com/gojalgajil/komposisiku)
**Framework & Core Technologies:** Next.js 16.0.8, React 19.2.1, TypeScript 5  
**Styling & UI:** Tailwind CSS 4, PostCSS  
**AI & OCR:** Google Gemini AI  
* Komposisiku leverages Google Gemini and Groq AI services to intelligently analyze products, extract detailed information from images, and provide comprehensive product insights through natural language processing.  
* Enables users to search for products, find alternatives, combine multiple products, and export results as images or PDFs, all within a modern Next.js interface with real-time AI-powered recommendations.  
🔗 Live: [https://komposisiku.vercel.app/](https://komposisiku.vercel.app/)

---

### 🛒 [Toko Apai Jaya (Mini Store)](https://github.com/gojalgajil/tokoapaijaya)
**Framework & Core Technologies:** Next.js 16.1.3, React 19.2.3, TypeScript 5  
...
### 📋 [DIA (Do It Anywhere)](https://github.com/gojalgajil/DIA)
**Frontend:** React 19.2.0, TypeScript 5.9.3, Vite 7.2.4, Redux  
**Backend:** PostgreSQL, Prisma 5.20.0  
...
### 💻 [Social Media Website](https://github.com/gojalgajil/Social-Media)
**Frontend:** React 19.2.0, TypeScript 5.9.3, Vite 7.2.4, Redux  
**Backend:** PostgreSQL, Prisma 5.20.0  
**Styling & UI:** Tailwind CSS 4.1.17, Lucide React 0.555.0, Radix  
...
- **LinkedIn:** [linkedin.com/in/karina-gozal](https://www.linkedin.com/in/karina-gozal/)
- **Email:** [kg.gozal@gmail.com](mailto:kg.gozal@gmail.com)
- **Portfolio:** [https://portfolio-karinagayatrigozal.vercel.app/](https://portfolio-karinagayatrigozal.vercel.app/)
