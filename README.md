...
**Styling & UI:** Tailwind CSS, shadcn/ui, Radix, Lucide React, Tailwind CSS Animate, next-themes  
...
**Framework & Core Technologies:** Next.js, React.js, TypeScript  
**Styling & UI:** Tailwind CSS, PostCSS  
**AI & OCR:** Google Gemini AI  
* Komposisiku leverages Google Gemini service to intelligently analyze products, extract detailed information from images, and provide comprehensive product insights through natural language processing.  
